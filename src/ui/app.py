...
class PDownloader(App):
    ...
    def on_mount(self):
        ...
        self.install_screen(AddLinksScreen(self.link_manager,self.settings), "add_links")

        self.install_screen(OptionsScreen(self.settings), "options")
    ...
    def update_download_progress(self, value, text):
        self.progress_manager.update(value, text)
